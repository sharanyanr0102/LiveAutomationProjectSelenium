...
public class TC_RF_001 {
	...
	public void register() throws Exception {
		...
		WebElement successMessage1 = driver.findElement(By.xpath("//div[@id='content']/p[1]"));
		Assert.assertTrue(
				successMessage1.getText().equals("Congratulations! Your new account has been successfully created!"),
				"Congratulations Message not displayed");
		Thread.sleep(1000);

		WebElement successMessage2 = driver.findElement(By.xpath("//div[@id='content']/p[2]"));
		Assert.assertTrue(successMessage2.getText().equals(
				"You can now take advantage of member privileges to enhance your online shopping experience with us."),
				"Member Privileges Message not displayed");
		Thread.sleep(1000);

		WebElement successMessage3 = driver.findElement(By.xpath("//div[@id='content']/p[3]"));
		Assert.assertTrue(successMessage3.getText().equals(
				"If you have ANY questions about the operation of this online shop, please e-mail the store owner."),
				"Contact Info Message not displayed");
		Thread.sleep(1000);

		WebElement successContactLink = driver.findElement(By.xpath("//div[@id='content']/p/a"));
		Assert.assertTrue(successContactLink.getText().equals("contact us"), "contact us link text not matching");
		Thread.sleep(1000);
		...
		WebElement editAccountLink = driver
				.findElement(By.xpath("//div[@id='content']/ul/li/a[.='Edit your account information']"));
		Assert.assertTrue(editAccountLink.isDisplayed());
